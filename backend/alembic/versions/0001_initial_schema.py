...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("created_at", sa.DateTime(timezone=True), server_default=sa.func.now(), nullable=False),
        sa.Column("updated_at", sa.DateTime(timezone=True), server_default=sa.func.now(), nullable=False),
        sa.UniqueConstraint("user_id", "date", name="uq_token_usage_user_date"),
    )
    ...
    op.create_table(
        ...
        sa.Column("request_preview", sa.String(length=200), nullable=False),
        sa.Column("response_preview", sa.String(length=200), nullable=False),
